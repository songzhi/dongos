...
macro_rules! interrupt_stack {
    ($name:ident, $stack: ident, $func:block) => {
        ...
        pub unsafe extern fn $name () {
            #[inline(never)]
            unsafe fn inner($stack: &mut $crate::interrupt::macros::InterruptStack) {
                $func
            }
            ...
            // Call inner rust function
            inner(&mut *(rsp as *mut $crate::interrupt::macros::InterruptStack));
...
macro_rules! interrupt_error {
    ($name:ident, $stack:ident, $func:block) => {
        ...
        pub unsafe extern fn $name () {
            #[inline(never)]
            unsafe fn inner($stack: &$crate::interrupt::macros::InterruptErrorStack) {
                $func
            }
...
macro_rules! interrupt_stack_p {
    ($name:ident, $stack: ident, $func:block) => {
        ...
        pub unsafe extern fn $name () {
            #[inline(never)]
            unsafe fn inner($stack: &mut $crate::interrupt::macros::InterruptStackP) {
                $func
            }
            ...
            // Call inner rust function
            inner(&mut *(rsp as *mut $crate::interrupt::macros::InterruptStackP));
...
macro_rules! interrupt_error_p {
    ($name:ident, $stack:ident, $func:block) => {
        ...
        pub unsafe extern fn $name () {
            #[inline(never)]
            unsafe fn inner($stack: &$crate::interrupt::macros::InterruptErrorStackP) {
                $func
            }
            ...
            // Call inner rust function
            inner(&*(rsp as *const $crate::interrupt::macros::InterruptErrorStackP));
